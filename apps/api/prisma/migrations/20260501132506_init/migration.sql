...
-- CreateEnum
CREATE TYPE "RoleType" AS ENUM ('SYSTEM', 'ORGANIZATION');

-- CreateEnum
CREATE TYPE "SettingScope" AS ENUM ('GLOBAL', 'ORGANIZATION', 'MODULE');
...
-- CreateIndex
CREATE UNIQUE INDEX "user_system_roles_userId_roleId_key" ON "user_system_roles"("userId", "roleId");

-- CreateIndex
CREATE UNIQUE INDEX "RolePermission_roleId_permissionId_key" ON "RolePermission"("roleId", "permissionId");

-- CreateIndex
CREATE INDEX "Setting_scope_organizationId_moduleCode_idx" ON "Setting"("scope", "organizationId", "moduleCode");

-- CreateIndex
CREATE UNIQUE INDEX "ModuleRegistry_code_key" ON "ModuleRegistry"("code");

-- CreateIndex
CREATE INDEX "ModuleSetting_moduleId_organizationId_idx" ON "ModuleSetting"("moduleId", "organizationId");
...
-- AddForeignKey
ALTER TABLE "user_system_roles" ADD CONSTRAINT "user_system_roles_userId_fkey" FOREIGN KEY ("userId") REFERENCES "User"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "user_system_roles" ADD CONSTRAINT "user_system_roles_roleId_fkey" FOREIGN KEY ("roleId") REFERENCES "Role"("id") ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "ModuleSetting" ADD CONSTRAINT "ModuleSetting_moduleId_fkey" FOREIGN KEY ("moduleId") REFERENCES "ModuleRegistry"("id") ON DELETE CASCADE ON UPDATE CASCADE;
